    ...
    async def on_message(self, message):
        ...
        if message.content[:1] == "/":
            ...
            if command == "setupChannel":
                ...
                await self.discord_client.send_message(self.log_channel, "The Channel {} was setup!".format(self.log_channel))
            elif command == "testChannel":
                if self.log_channel:
                    await self.discord_client.send_message(self.log_channel, "Channel erfolgreich getestet!")
                else:
                    await self.discord_client.send_message(message.channel, "Channel test ist Fehlgeschlagen!")
